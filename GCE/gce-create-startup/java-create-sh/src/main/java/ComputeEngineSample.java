...
public class ComputeEngineSample {
   ...
   */
  private static final String APPLICATION_NAME = "nginx-instance-demo-java";

  /** Set PROJECT_ID to your Project ID from the Overview pane in the Developers console. */
  private static final String PROJECT_ID = "devopev";
  ...
  private static final String SAMPLE_INSTANCE_NAME = "nginx-instance-demo-java-2";
  ...
  private static final String SOURCE_IMAGE_PATH = "projects/devopev/global/images/jupytervm";
  ...
  public static Operation startInstance(Compute compute, String instanceName) throws IOException {
    ...
    //item.setValue("gs://devopev/nginx_startup.sh");
